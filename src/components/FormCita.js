    ...
    useEffect(() => {
        const fetchHorarios = async () => {
            if (selectedEspecialidad && selectedDate) {
                try {
                    const response = await axios.get(`http://localhost:8000/api/horarios-por-fecha-medico`, {
                        params: { idMedico: selectedMedico, Fecha: selectedDate }
                    });
    ...
    return (
        <>
            <Form onSubmit={handleSubmit}>
                ...
                {selectedEspecialidad && selectedMedico && (
                    <Form.Group as={Col} md={{ span: 12 }}>
                ...
                {selectedEspecialidad && selectedMedico && selectedDate && (
                    <Form.Group as={Col} md={{ span: 12 }}>
